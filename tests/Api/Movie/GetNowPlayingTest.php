...
class GetNowPlayingTest extends WebTestCase
{
    use ResponseTestTrait;

    public function testGetLatest()
    {
        $hollywoodManager = $this->setupManager(PaginatedMovieResponse::RESPONSE, 'GET', 'https://api.themoviedb.org/3/movie/now_playing');
        $hollywoodManagerResponse = $hollywoodManager->movies()->getNowPlaying();
