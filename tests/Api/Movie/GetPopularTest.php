...
class GetPopularTest extends WebTestCase
{
    use ResponseTestTrait;

    public function testGetLatest()
    {
        $hollywoodManager = $this->setupManager(PaginatedMovieResponse::RESPONSE, 'GET', 'https://api.themoviedb.org/3/movie/popular');
        $hollywoodManagerResponse = $hollywoodManager->movies()->getPopular();
