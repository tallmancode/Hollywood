...
class GetAiringTodayTest extends WebTestCase
{
    use ResponseTestTrait;

    public function testAiringToday()
    {
        $hollywoodManager = $this->setupManager(PaginatedTvResponse::RESPONSE, 'GET', 'https://api.themoviedb.org/3/tv/airing_today');
        $hollywoodManagerResponse = $hollywoodManager->television()->getAiringToday();
