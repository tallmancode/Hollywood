...
class GetPopularTest extends WebTestCase
{
    ...
    {
        $hollywoodManager = $this->setupManager(PaginatedTvResponse::RESPONSE, 'GET', 'https://api.themoviedb.org/3/tv/popular');
        $hollywoodManagerResponse = $hollywoodManager->television()->getPopular();
